...
// Close the prepared statement.
  $stmt->close();
  header('location:rejected.php?msg=success');
}
...
<html>
<head>
  <link rel = "stylesheet" type = "text/css" href = "../css/rejected.css">
...
<input type = "radio" name = "decision" value = "approved"> APPROVE<br/>
